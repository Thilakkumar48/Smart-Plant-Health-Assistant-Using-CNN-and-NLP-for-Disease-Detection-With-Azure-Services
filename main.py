...
if uploaded_file is not None:
    ...
    if response.status_code == 200:
        ...
        if predictions:
            ...
            predicted_disease = tag_name  # Store the predicted disease name
...
plant_symptoms = st.text_input("Enter plant symptoms for diagnosis:", predicted_disease if predicted_disease else "Black Rot")
...
languages = st.multiselect("Select languages to translate to", ['en', 'es', 'fr', 'te', 'hi', 'de', 'kn'])
